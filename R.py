...
if(expirydate>today):
    ...
    while(True):
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("14th Mar 2022, 02:30 PM- 03:00 PM")
            print("14th Mar 2022, 05:30 PM- 06:00 PM")
            print("14th Mar 2022, 08:30 PM- 09:00 PM")
            print("lease play on the given time, and ")
            ...
            clear()
            print("----------Your play time-----------")
            print("14th Mar 2022,  08:00 PM- 08:30 PM")
            print("15th Mar 2022, 08:00 PM- 08:30 PM")
            print("16th Mar 2022, 08:00 PM- 08:30 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
